...
use App\Containers\AppSection\Restaurant\Tasks\GetRoomAndTableNoTask;
...
class GetRoomAndTableNoAction extends ParentAction
{
    public function run(GetRoomAndTableNoRequest $request)
    {
        // return "hiiii";
        ...
        return app(GetRoomAndTableNoTask::class)->run($request);
    }
}
