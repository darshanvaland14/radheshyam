...
use App\Containers\AppSection\Restaurant\Tasks\CreateOrUpdateKotBillTask;
...
class CreateOrUpdateKotBillAction extends ParentAction
{


    public function run(CreateOrUpdateKotBillRequest $request)
    {
        // return "hiiii";
        ...
        return app(CreateOrUpdateKotBillTask::class)->run($request);
    }
}
