...
use App\Containers\AppSection\Booking\Tasks\GetAllBookingmastersTask;
use App\Containers\AppSection\Booking\UI\API\Requests\GetAllBookingmastersRequest;
use App\Ship\Parents\Actions\Action as ParentAction;
use Prettus\Repository\Exceptions\RepositoryException;

class GetAllBookingmastersAction extends ParentAction
{
    public function run(GetAllBookingmastersRequest $request)
    {
        return app(GetAllBookingmastersTask::class)->run($request);
    }
}
