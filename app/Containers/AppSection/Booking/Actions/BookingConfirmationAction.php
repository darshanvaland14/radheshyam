...
class BookingConfirmationAction extends ParentAction
{
    public function run(BookingConfirmationRequest $request)
    {
        return app(BookingConfirmationTask::class)->run($request);
    }
}
