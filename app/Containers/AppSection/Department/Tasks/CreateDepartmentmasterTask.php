...
class CreateDepartmentmasterTask extends ParentTask
{
    use HashIdTrait;
    ...
    {
        try {
            $createData = Department::create($data);
            $getData = Department::where('id', $createData->id)->first();
            if ($getData !== null) {
                ...
                $returnData['object'] = "Department Master";
            }
            return $returnData;
        } catch (Exception $e) {
            return [
