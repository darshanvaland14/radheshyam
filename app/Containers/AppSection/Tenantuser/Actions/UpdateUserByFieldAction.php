...
use App\Containers\AppSection\Tenantuser\Tasks\UpdateUserByFieldTask;
...
class UpdateUserByFieldAction extends ParentAction
{
    use HashIdTrait;
    public function run(UpdateTenantuserRequest $request, $InputData)
    {
        return app(UpdateUserByFieldTask::class)->run($InputData, $request->id);
    }
}
