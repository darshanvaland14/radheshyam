...
use App\Containers\AppSection\Tenantuser\Tasks\OldPasswordCheckTask;
...
class OldPasswordCheckAction extends Action
{
  public function run(GetAllTenantusersRequest $request, $InputData)
  {
    return app(OldPasswordCheckTask::class)->run($InputData);
  }
}
