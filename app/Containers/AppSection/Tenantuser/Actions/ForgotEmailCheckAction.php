...
use App\Containers\AppSection\Tenantuser\Tasks\ForgotEmailCheckTask;
...
class ForgotEmailCheckAction extends Action
{
  public function run(GetAllTenantusersRequest $request, $InputData)
  {
    return app(ForgotEmailCheckTask::class)->run($InputData);
  }
}
