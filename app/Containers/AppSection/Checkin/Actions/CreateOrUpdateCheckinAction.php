...
use App\Containers\AppSection\Checkin\Tasks\CreateOrUpdateCheckinTask;
...
class CreateOrUpdateCheckinAction extends ParentAction
{
    use HashIdTrait;
    ...
    public function run(CreateOrUpdateCheckinRequest $request)
    {
        ...
        //     'depart_to' => $request->depart_to,
        //     'purpose_of_visit' => $request->purpose_of_visit,
        //     'room_allocation' => $allocatedRoom,
        // ];
        // return $data;
        return app(CreateOrUpdateCheckinTask::class)->run($request);
    }
}
