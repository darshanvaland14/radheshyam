...
class FindHotelroommasterByHotelIdWithStatusTask extends ParentTask
{
    use HashIdTrait;
    ...
    public function run($id)
    {
        ...
        try {
            $getData = Hotelroom::where('hotel_master_id', $id)->where('status', 'available')->orderBy('id', 'ASC')->get();
            $returnData = array();
